import { Typography, Button, SvgIcon, Grid } from '@material-ui/core'
    ...
    <SvgIcon viewBox="0 0 147.7 17.5" className={className}>
      <g>
        <path
          id="Path_3507"
          fill="#FFFFFF"
          d="M142.5,0.5l-3.4,6.1l-3.4-6.1h-5.3l6.3,10.4v6.2h4.6v-6.3l6.3-10.3H142.5z"
        />
        <path id="Path_3506" fill="#FFFFFF" d="M110.9,0.5v16.6h12.7v-4h-8.1V0.5H110.9z" />
        <path
          id="Path_5"
          fill="#FFFFFF"
          d="M85.9,17.1V0.5h6.4c2.5-0.1,5,0.7,6.9,2.3c1.7,1.5,2.6,3.7,2.5,6c0.1,2.3-0.9,4.5-2.5,6
        ...
        <path
          id="Path_7"
          fill="#FFFFFF"
          d="M7.8,17.4c-2.9,0.1-5.6-0.9-7.8-2.8l2.6-3.1c1.5,1.3,3.4,2,5.4,2c1.3,0,1.9-0.4,1.9-1.2
