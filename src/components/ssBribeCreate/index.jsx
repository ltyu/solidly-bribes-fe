                      ...
                      <div className={classes.menuOption}>
                        <div className={classes.doubleImages}>
                          <Image
                            ...
                            alt=""
                            src={option?.token0?.logoURI ? `${option.token0.logoURI}` : '/tokens/unknown-logo.png'}
                            width="70px"
                            height="70px"
                            onError={(e) => {
                          ...
                          <Image
                            ...
                            alt=""
                            src={option?.token1?.logoURI ? `${option.token1.logoURI}` : '/tokens/unknown-logo.png'}
                            width="70px"
                            height="70px"
                            onError={(e) => {
                              e.target.onerror = null
    ...
    return (
      <MenuItem val={asset.address} key={asset.address + '_' + idx} className={classes.assetSelectMenu}>
        <div className={classes.assetSelectMenuItem}>
          <div className={classes.displayDualIconContainerSmall}>
            <Image
              ...
              alt=""
              src={asset?.logoURI ? `${asset.logoURI}` : '/tokens/unknown-logo.png'}
              width="70px"
              height="60px"
              onError={(e) => {
                e.target.onerror = null
        ...
        <div className={classes.assetSelectIconName}>
          <Typography variant="h5">{asset?.symbol ? asset.symbol : '/tokens/unknown-logo.png'}</Typography>
  ...
  const renderAssetOption = (type, asset, idx) => {
    return (
      ...
      >
        ...
        <div className={classes.assetSelectIconName}>
          <Typography variant="h5">{asset?.symbol ? asset.symbol : ''}</Typography>
          <Typography variant="subtitle1" color="textSecondary">
            {asset ? asset.name : ''}
          </Typography>
        </div>
        <div className={classes.assetSelectBalance}>
          <Typography variant="h5">
            {asset?.balance && asset.balance ? formatCurrency(asset.balance) : '0.00'}
          </Typography>
          <Typography variant="subtitle1" color="textSecondary">
            {'Balance'}
          </Typography>
        ...
        <div className={classes.assetSelectMenuItem}>
          <div className={classes.displayDualIconContainer}>
            <Image
              ...
              alt=""
              src={value?.logoURI ? `${value.logoURI}` : '/tokens/unknown-logo.png'}
              width="100px"
              height="100px"
              onError={(e) => {
                e.target.onerror = null
